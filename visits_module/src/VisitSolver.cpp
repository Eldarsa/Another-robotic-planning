...
void VisitSolver::loadSolver(string *parameters, int n){
  ...
  string waypoint_file = "/home/antony/visits/visits_domain/waypoint.txt";   // change this to the correct path
  parseWaypoint(waypoint_file);

  string landmark_file = "/home/antony/visits/visits_domain/landmark.txt";  // change this to the correct path
